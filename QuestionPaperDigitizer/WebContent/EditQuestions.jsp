...
<c:if test="${requestScope.RCRDDATA ne null }">
      ...
      <form method="post" action="Update" enctype="multipart/form-data" >
        ...
        <div class="control-group after-add-more w3-padding-large">
          ...
          <c:forEach var="rcrddata" items="${requestScope.RCRDDATA}">
          
            <h2 class="w3-xlarge w3-text-blue"><b>Edit and press Update</b></h2><br>
          <input type="email" name="email" value="<c:out value='${rcrddata.CEmail}'></c:out>" placeholder=" Set a new email " style="width:100%; max-width:800px" class="w3-input " required/><br>
          
          
          <input type="password" name="password" id="password" value="<c:out value='${rcrddata.Password}'></c:out>" placeholder=" Set a new Password " style="width:100%; max-width:800px" class="w3-input " required/><br>
          <input type="password" name=" confirm_password " id="confirm_password" value="<c:out value='${rcrddata.Password}'></c:out>" placeholder="Confirm Password" style="width:100%; max-width:800px" class="w3-input " required/>
          ...
          <input type="text" name="title" value="<c:out value='${rcrddata.Title}'></c:out>" placeholder=" Title for your question form" style="width:100%; max-width:800px" class="w3-input " required/><br><br>
          ...
          <textarea name="qinfo" style="width:100%; max-width:800px; resize:none;" class=" w3-round-large w3-border w3-input "  rows="3" cols="10" placeholder=" Enter some details here "  required> <c:out value='${rcrddata.QFInfo}'></c:out> </textarea><br><br><br>
       ...
       <c:forEach var="docdata" items="${requestScope.DOCDATA}">
          ...
          <textarea name="question" class="w3-input "  rows="1" cols="10" placeholder="  Drop Your Question Here" style="resize:none;" required> <c:out value='${docdata.Question}'></c:out> </textarea>
            ...
            <div class="w3-text-blue w3-small w3-padding-small w3-round"><i class='fas fa-ellipsis-h ' style='font-size:22px'></i></div>
              ...
              <div class="w3-dropdown-content w3-bar-block w3-card-4 w3-animate-zoom w3-padding">
                 ...
                 <input class="w3-input w3-small" type="text" name="label" value="<c:out value='${docdata.Label}'></c:out>" required/><br>
                 <i class="w3-tiny w3-text-gray">Set sub-questions or options for MCQ</i>
                 <p class="w3-tiny">
                 <c:forEach var="optn" items="${docdata.SQoMCQO}">
                  <input class="w3-input w3-tiny " type="text" name="sqomcqo" value="<c:out value='${optn}'></c:out>" required/>
                  </c:forEach>
                 </p>
                 </details>
                ...
                <details>
                 ...
                 <p class="w3-tiny">
                       <input type="number" value="<c:out value='${docdata.Marks}'></c:out>" name="marks" size="10" class=" w3-round-large" min="1" max="100" required>
                 </p>
        ...
        <br><br>
        <p class="w3-tiny w3-text-gray"><b>If any required field is left unfilled/unselected, 'Update' button will not be executed.So please check each required field before updating.</b></p>
        <input type="submit" class="w3-button w3-blue w3-small w3-round" value="Update"/>
    ...
    <div class="w3-padding-large">
      <button class="w3-button w3-hover-white add-more"><i class='fas fa-plus-circle w3-text-blue' style='font-size:35px'></i></button>
...
<c:if test="${requestScope.RCRDDATA eq null }">
